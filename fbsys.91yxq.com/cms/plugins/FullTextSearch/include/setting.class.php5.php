...
class PluginSetting extends iData
{
				...
				public function getAllFullText( $TableID )
				{
								global $plugin_table;
								global $db;
								global $table;
				...
				public function getFullText( $SearchID )
				{
								global $plugin_table;
								global $db;
								global $table;
				...
				public function getAllFullTextedFields( $TableID )
				{
								global $plugin_table;
								global $db;
								global $table;
				...
				public function delFullText( $TableID, $SearchID )
				{
								global $plugin_table;
								global $db;
								global $table;
				...
				public function addFullText( $TableID, $SearchName, $Fields )
				{
								global $plugin_table;
								global $table;
								global $db;
