...
class tpl_cate_admin extends iData
{
				...
				public function getCateInfo( $TCID, $field = "*" )
				{
								global $table;
								global $db;
								global $sys;
				...
				public function getAll( $ParentTCID = 0 )
				{
								global $table;
								global $db;
								global $sys;
				...
				public function getAll4Tree( $ParentTCID = 0 )
				{
								global $table;
								global $db;
								global $sys;
				...
				public function canAccess( &$CateInfo, $mode )
				{
								global $sys;
				...
				public function isCreationUser( &$CateInfo )
				{
								global $sys;
								if ( $sys->session['sGIsAdmin'] == 1 )
								{
