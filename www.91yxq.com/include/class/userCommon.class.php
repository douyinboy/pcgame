...
class userCommon{
	...
	/*用户注册*/
	function reg($username,$pows,$mail,$sex,$id_card,$question='',$answer='',$agent_id,$game_id,$server_id='0',$placeid='',$from_url='',$adid='',$truename='',$rand='1',$cplaceid='',$pcid, $from){
        ...
        switch ($from) {
            case 'quba':
                $str = 'reg_bengbeng&do=reg_quba'; break;
            case 'youyiwang':
                $str = 'reg_bengbeng&do=reg_youyiwang'; break;
            case 'shitoucun':
                $str = 'reg_bengbeng&do=reg_shitoucun'; break;
            case 'tiantianzuan':
                $str = 'reg_bengbeng&do=reg_tiantianzuan'; break;
            case 'ledouwan':
                $str = 'reg_bengbeng&do=reg_ledouwan'; break;
            case 'jiquwang':
                $str = 'reg_bengbeng&do=reg_jiquwang'; break;
            case 'jujuwan':
                $str = 'reg_bengbeng&do=reg_jujuwan'; break;
            case 'yiruite':
                $str = 'reg_bengbeng&do=reg_yiruite'; break;
        }

		$sty_states=long_login($info, time(),$str);
