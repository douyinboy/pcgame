...
switch($IN[o]) {
	...
	case 'add_submit':
		...
		*/
		...
		if($user->add()) { 
			...
			//$user_extra->add();
			fgoto("view", 'add_user_ok');

		} else {
			fgoto("view", 'add_user_fail');
	...
	case 'edit_submit':
		...
		if($user->update($IN[uId])) { 
			...
			fgoto("view", 'edit_user_ok');

		} else {
			fgoto("view", 'edit_user_fail');
	...
	case 'del':
		...
		if($user->del($IN[uId])) {
			...
			fgoto("view", 'del_user_ok');
			
		} else
			fgoto("view", 'del_user_fail');
