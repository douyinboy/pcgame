...
window.onload=function(){document.charset='<?php echo $this->_tpl_vars["charset"];?>';}
...
{	
	var fitXP = "<?php echo $this->_tpl_vars["SYS_ENV"]["DialogFitXP"];?>",params = {},tmp=param.split(";"),tmp_;
...
function commonDisplayPickerUI(action, srcValue) {
	...
	switch(action) {
		...
		case 'date':
			...
			break;
		case 'upload_img':
			var arr = showMeDialog('upload.php?sId=<?php echo $this->_tpl_vars["sId"];?>&o=display&mode=one&type=img_picker&NodeID=' + NodeID,"color","dialogWidth:390px;dialogHeight:120px;help:0;status:0;scroll:no;resizable:no;maximize:no");
			break;
		case 'upload_attach':
