...
class extra_publish_admin extends iData
{
				...
				public function update( $PublishID )
				{
								global $table;
								global $sys;
								$this->addData( "LastModifiedUserID", $sys->session['sUId'] );
				...
				public function getAll( $NodeID = 0 )
				{
								global $table;
								global $db;
				...
				public function getInfo( $PublishID )
				{
								global $db;
								global $table;
				...
				public function getView( $PublishID )
				{
								global $iWPC;
				...
				public function refresh( &$PublishInfo, &$NodeInfo, $filename )
				{
								global $iWPC;
								global $SYS_ENV;
				...
				public function _publishing( &$NodeInfo, &$PublishInfo, $filename, $content )
				{
				...
				public function getHtmlURL( $PublishInfo, $NodeInfo )
				{
