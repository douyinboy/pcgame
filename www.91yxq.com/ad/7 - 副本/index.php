...
<title>6qwan《热血三国2》今年最好玩的游戏</title>
<script type="text/javascript" src="http://image.6qwan.com/newvossion/js/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="http://image.6qwan.com/jsCommon/userClass.js"></script>
</head>
<!--css样式-->
<style type="text/css">
 ...
 <div style=" width:1000px; height:700px;margin:0 auto;">
   <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="1400px" height="700">
    ...
    <param name="allowScriptAccess" value="always" >
     <embed src="index.swf" width="1000px" height="600" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allowScriptAccess="always"></embed>
   </object>
 </div>
 </div> 
<!--flash结束-->
...
<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1256441440'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1256441440' type='text/javascript'%3E%3C/script%3E"));</script>
</body>
</html>