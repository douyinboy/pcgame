...
/**
 *http://api.demo.com/api/pc_egg/get_reward5_by_api.php?merid=7778&user_name=allen&keycode=szdfgsd
 */
...
switch ($game_id) {
    case 1:
        $server_id_arr = [28, 29, 30, 31, 32];break;   //魔神变
    case 3:
        $server_id_arr = [61, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77];break;   //热血虎卫
}
