...
class XML_SimpleXMLParser
{
				...
				public function XML_SimpleXMLParser( )
				{
				}

				public function parseFile( $_file, $_xpath )
				{
				...
				public function parse( $_content, $_xpath )
				{
								$this->returnValue = array( );
				...
				public function getXMLFileEncoding( $_file )
				{
								$this->File =& get_singleton( "FileSystem.File" );
								$xml_content = $this->File->read( $_file );
								$this->returnValue = array( );
				...
				public function _parsing( $_content, $_xpath )
				{
				...
				public function _parsingSub( $_content, $_xpath )
				{
				...
				public function _getElementInnerData( $_element, $_content )
				{
				...
				public function _parsingAuto( $_content )
				{
								$return = array( );
				...
				public function unescapedata( $data )
				{
