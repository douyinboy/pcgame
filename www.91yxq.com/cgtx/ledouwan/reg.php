<?php
    /**
     * @注册接口  http://www.91yxq.com/cgtx/ledouwan/index.php?luid=209795&lwid=2635&ltype=pagegame
     */
    ...
    $url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=19&agent_id=10028&adid=".$adid;
    $ch = curl_init();
