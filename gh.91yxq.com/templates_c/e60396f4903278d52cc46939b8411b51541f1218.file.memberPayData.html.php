<?php /* Smarty version Smarty-3.1.7, created on 2016-12-15 15:46:14
         compiled from "./templates/recharge/memberPayData.html" */ ?>
<?php /*%%SmartyHeaderCode:96165669156a32aca162bd5-48615962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e60396f4903278d52cc46939b8411b51541f1218' => 
    array (
      0 => './templates/recharge/memberPayData.html',
      1 => 1456973056,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '96165669156a32aca162bd5-48615962',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_56a32aca32cfe',
  'variables' => 
  array (
    'currentpage' => 0,
    'numperpage' => 0,
...
<?php if ($_valid && !is_callable('content_56a32aca32cfe')) {function content_56a32aca32cfe($_smarty_tpl) {?><form id="pagerForm" action="" method="post">
...
<div class="pageHeader">
    ...
    <div class="searchBar">
        <ul class="searchContent">
            <li><label>游戏服区：</label>
            <select class="combox" name="game_id" id="game_id" ref="server_91yxq_81" refUrl="?action=sysmanage&opt=getServers&game_id={value}">
...
" <?php if ($_POST['game_id']==$_smarty_tpl->tpl_vars['v']->value['id']){?> selected <?php }?> ><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
                ...
                <select class="combox" name="server_id" id="server_91yxq_81">
                <option value="0">请选择</option>
                <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
&detail=1&placeid=<?php echo $_smarty_tpl->tpl_vars['vo']->value['placeid'];?>
...
" width="800" height="520" title="成员：<?php echo $_smarty_tpl->tpl_vars['vo']->value['membername'];?>
