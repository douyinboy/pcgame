...
<?php /*%%SmartyHeaderCode:2663858a42b45bfc900-87554441%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2663858a42b45bfc900-87554441',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58a42b45df47f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58a42b45df47f')) {function content_58a42b45df47f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\phpStudy\\WWW\\91yxq\\admin.91yxq.com\\Smarty-3.1.7/plugins\\modifier.date_format.php';
...
" class="on"><span class="l"></span><span class="r"><?php echo $_smarty_tpl->tpl_vars['topMenu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec']['index']]['title'];?>
        ...
        <div class="head_info_box">
            <div class="head_info">
                <a href="javascript:void(0);">用户组： <?php echo $_SESSION['admin']['gName'];?>
</a>
                <span class="line">|</span>
                <a href="javascript:void(0);">用户名： <?php echo $_SESSION['admin']['name'];?>
</a>
                <span class="line">|</span>
                <a href="?action=sysmanage&opt=cmdata" target="dialog" width="600">修改资料</a>
                <span class="line">|</span>
