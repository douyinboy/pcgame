...
class LogAdmin extends iData
{
				...
				public function addLoginLog( $uName, $IP, $state = false )
				{
								global $table;
								if ( $state == true )
								{
				...
				public function addAdminLog( $uName, $IP, &$IN )
				{
								global $table;
				...
				public function addFileLog( $type, $data )
				{
								switch ( $type )
								{
								case "login" :
				...
				public function delLoginLog( $LogID )
				{
								global $table;
								$which = "LogID";
				...
				public function delAdminLog( $LogID )
				{
								global $table;
								$which = "LogID";
				...
				public function delLoginLogByTime( $start_time, $end_time )
				{
								global $table;
								global $db;
				...
				public function delAdminLogByTime( $start_time, $end_time )
				{
								global $table;
								global $db;
				...
				public function getLoginLogRecordNum( )
				{
								global $table;
								global $db;
				...
				public function getAdminLogRecordNum( )
				{
								global $table;
								global $db;
				...
				public function getLoginLogLimit( $start, $offset )
				{
								global $table;
								global $db;
				...
				public function getAdminLogLimit( $start, $offset )
				{
								global $table;
								global $db;
				...
				public function searchLoginLogRecordNum( $params )
				{
								global $table;
								global $db;
								switch ( $params['field'] )
				...
				public function searchLoginLogLimit( $params )
				{
								global $table;
								global $db;
								switch ( $params['field'] )
				...
				public function searchAdminLogRecordNum( $params )
				{
								global $table;
								global $db;
								switch ( $params['field'] )
				...
				public function searchAdminLogLimit( $params )
				{
								global $table;
								global $db;
								switch ( $params['field'] )
