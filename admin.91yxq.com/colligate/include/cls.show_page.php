...
*/
 ...
 class ShowPage {
	...
	//下拉跳转页面
	 function JumpPage() {
	     $Jump = "  &nbsp;页码：<b><font color='red'>".$this->PageNum()."</font></b>/<b><font color='red'>".$this->PageCount()."</font></b> ";
	...
	//生成导航条
	 function ShowLink() {
             $data="";
          //  if(empty($this ->FristPage()) || empty($this->PrePage()) || empty($this->NextPage()) || empty($this->LastPage())){
                 $data.=$this->FristPage().$this->PrePage().$this->NextPage().$this->LastPage();
         //   }
            $data.=$this->JumpPage();
            return $data;
	 }
