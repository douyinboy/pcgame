...
class Plugin extends iData
{
				...
				public $CACHE_AllPlugins = NULL;

				public function canAccess( $plugin )
				{
								global $db;
								global $table;
								global $sys;
				...
				public function update( $publishInfo )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function editField( $TableID, $fieldInfo, $data )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function delField( $TableID, $fieldInfo )
				{
								global $table;
								global $db;
								global $db_config;
