<?php
/**
 * @注册接口  http://www.91yxq.com/rxhw/ledouwan/reg.php?luid=&lwid=2638&ltype=pagegame
 */
...
$url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=3&agent_id=10028&adid=".$adid;
$ch = curl_init();
