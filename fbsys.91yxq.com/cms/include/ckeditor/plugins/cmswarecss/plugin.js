CKEDITOR.plugins.add('cmswarecss',
{
	init : function( editor ){
		...
		css.push('.cke_skin_', config.skin ,' .cke_top,.cke_skin_v2 .cke_bottom,.cke_shared .cke_skin_v2{background-color:#d6d3ce;}');
		css.push('.cke_skin_', config.skin ,' .cke_button a,.cke_skin_v2 .cke_button a:hover,.cke_skin_v2 .cke_button a:focus,.cke_skin_v2 .cke_button a:active,.cke_skin_v2 .cke_button a.cke_off{border:solid 1px #d6d3ce;}');
		css.push('.cke_skin_', config.skin ,' .cke_button a,.cke_skin_v2 .cke_button a.cke_off{background-color:#d6d3ce;}');
		css.push('.cke_skin_', config.skin ,' .cke_path a,.cke_skin_v2 .cke_path .cke_empty{border:solid 1px #d6d3ce;background-color:#d6d3ce;}');
