...
class adminDatabase
{
				...
				public function listTablesStatus( )
				{
								global $db;
								global $table;
								global $db_config;
				...
				public function backupInit( $tablename, $drop )
				{
								global $table;
								global $db;
								global $_SESSION;
				...
				public function bakTables( $tablename, $backPath )
				{
								if ( count( $tablename ) == 0 )
								{
												return false;
				...
				public function dumptable( $table_name, $start = 0, $offset = 0 )
				{
								global $db;
								$tabledump .= "";
								$db->SetFetchMode( "num" );
