...
class collection_admin extends iData
{
				...
				public function import( $CollectionID, $targetNodeID, $CateInfo )
				{
								global $publish;
								global $sys;
								global $_Counter;
				...
				public function del( $CateInfo, $CollectionID )
				{
								global $db_config;
								global $resource;
								global $SYS_ENV;
				...
				public function recordExists( $CateInfo, $url )
				{
								global $db_config;
								global $iWPC;
								global $db;
				...
				public function getCollectionLimit( &$CateInfo, $start = 0, $offset = 15 )
				{
								global $db;
								global $db_config;
								global $sys;
				...
				public function getCollectionRecordNum( $CateInfo, $State = "!= -1" )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function getCollectionInfo( $CateInfo, $CollectionID, $field = "*" )
				{
								global $table;
								global $db;
								global $iWPC;
				...
				public function update( $CateInfo, $CollectionID )
				{
								global $db_config;
								global $iWPC;
								$table_name = $db_config['table_pre'].$db_config['table_collection_pre']."_".$CateInfo[TableID];
				...
				public function getNoteList( $CateInfo, $collectionID )
				{
								global $db;
								global $table;
								global $sys;
