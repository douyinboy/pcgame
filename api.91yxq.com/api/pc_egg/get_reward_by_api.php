...
/**
 *http://api.demo.com/api/pc_egg/get_reward_by_api.php?merid=7778&user_name=allen&keycode=szdfgsd&gid=19
 */
...
//判断参数是否为空
if ($user_name == '' || $merid == '' || $keycode == '' || $game_id == '') {
    $state = 0;
    $content = '所有参数均不能为空!';
}
...
switch ($game_id) {
    ...
    case 2:
        $server_id_arr = [1, 2, 3];break;   //斗破沙城
    case 3:
        $server_id_arr = [1, 2, 3, 4];break;   //热血虎卫
    case 19:
