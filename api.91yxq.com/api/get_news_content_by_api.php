...
/**
 * @通过API添加游戏列表
 * @param url http://api.demo.com/api/get_news_content_by_api.php?time=153545615244&sign=245s4df45s4d5f4s5d4f&IndexID=222
 */
...
$sql = "SELECT Title, PublishDate, Title, Content FROM  " . PUBLISH . "." . PUBLISH_1 . " WHERE IndexID = " . htmlspecialchars(trim($_GET['IndexID']));
