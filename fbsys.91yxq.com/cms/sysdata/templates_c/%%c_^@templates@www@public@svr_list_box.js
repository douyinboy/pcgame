...
?>
   ...
   foreach ($this->_tpl_vars['List'] as  $this->_tpl_vars['key']=>$this->_tpl_vars['var']): ?>
							<?php if($this->_tpl_vars['key']<10): ?>
							'<dd>'+
								'<a href="<?php echo $this->_tpl_vars["91yxq_url"];?>/turn.php?act=gamelogin&game_id=<?php echo $this->_tpl_vars["var"]["GameId"];?>&server_id=<?php echo $this->_tpl_vars["var"]["ServerId"];?>" target="_blank">'+
									'<span class="date"><?php echo utf8_CsubStr($this->_tpl_vars["var"]["OpenDate"],5,10, "");?></span>'+
									'<span class="time"><?php echo $this->_tpl_vars["var"]["OpenTime"];?></span>'+
									'<span class="name"><?php echo $this->_tpl_vars["var"]["GameName"];?></span>'+
									'<span class="zone"><?php echo $this->_tpl_vars["var"]["ServerId"];?>服</span>'+
								'</a>'+
							'</dd>'+
							<?php endif;?>
					...
					<?php if(count($this->_tpl_vars['List'])>=10): ?>
...
?>
   ...
   foreach ($this->_tpl_vars['List'] as  $this->_tpl_vars['key']=>$this->_tpl_vars['var']): ?>
	...
	function loadFO(){
		...
		fo.setAttribute('src','<?php echo $this->_tpl_vars["91yxq_image_url"];?>/js/jq.foshow.js');
