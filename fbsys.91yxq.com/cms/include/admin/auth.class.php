...
class Auth
{
				...
				public function login( $username, $password, $IpSecurity = 0 )
				{
								global $db;
								global $table;
				...
				public function getPublishAuth( $gPublishAuth )
				{
				...
				public function registerSession( $result, $IpSecurity = 0 )
				{
								global $db;
								global $table;
								global $SYS_AUTH;
				...
				public function canManagePublish( $o, $NodeID )
				{
								global $iWPC;
								if ( $this->isAdmin( ) )
								{
