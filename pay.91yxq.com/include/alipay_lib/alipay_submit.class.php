...
class AlipaySubmit {
	...
	function buildForm($para_temp, $gateway, $method, $button_name, $aliapy_config) {
		...
		$sHtml = "<form id='order' name='order' action='".$gateway."_input_charset=".trim(strtolower($aliapy_config['input_charset']))."' method='".$method."'>";
		...
		//$sHtml = $sHtml."<script>document.forms['alipaysubmit'].submit();";
