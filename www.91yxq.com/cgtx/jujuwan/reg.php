...
/**
* @description 通用注册入口
* @注册接口  http://www.91yxq.com/cgtx/jujuwan/index.php?regid=64756544&adid=1
 */
	...
	$url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=19&agent_id=10030&adid=".$adid;
    $ch = curl_init();
