...
function forecolor() {
  if (!Error()) return;
  var arr = showMeDialog("ui.php?sId=<?php echo $this->_tpl_vars["sId"];?>&o=editor__color.htm","color","dialogWidth:200pt;dialogHeight:175pt;help:0;status:0");
...
function insertpagesign(){
	 if (!Error()) return;
ab=showMeDialog("ui.php?sId=<?php echo $this->_tpl_vars["sId"];?>&o=editor__page.html","color","dialogWidth:290pt;dialogHeight:50pt;help:0;status:0");
...
function insertattach(value, sform, element){
  ...
  if (value!=null && value['url']!="" && value['url']!= null) {
	...
	var str = "<a href=\""+ value['url'] +"\" target=\"_blank\"><img src='<?php echo $this->_tpl_vars["PUBLISH_URL"];?>/images/icon/" + value['suffix'] + ".gif' border=\"0\">" + value['src_name'] + "</a>" ;
	...
	if(myArray!= null && myArray[5] != null) {
		var str = "<a href=\""+ value +"\" target=\"_blank\"><img src='<?php echo $this->_tpl_vars["PUBLISH_URL"];?>/images/icon/" + myArray[5] + ".gif' border=\"0\">" + myArray[3] + myArray[4] + myArray[5] + "</a>" ;
...
function intable(){
  if (!Error()) return;
  ab=showMeDialog("ui.php?sId=<?php echo $this->_tpl_vars["sId"];?>&o=editor__table.html","color","dialogWidth:300pt;dialogHeight:180pt;help:0;status:0");
...
function setSave(NewMode){
  ...
  //  sContents=sContents.replace(/<(\/|)(tr|tbody|table)(.[^\<]*|)>/ig,'\<?php echo $this->_tpl_vars["1$2"];?>');
   // sContents=sContents.replace(/<(\/|)(td|th)(.[^\<]*|)>/ig,'\<?php echo $this->_tpl_vars["1$2$3"];?>');
  //  sContents=sContents.replace(/\[(td|th)/ig,'    \[$1');
    ...
    var aryCode2 = new Array("<li>","<?php echo $GLOBALS[''];?>","</li>","","<font size=","[size=","<font color=","[color=","<font face=","[face=");
