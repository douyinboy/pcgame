...
class Resource
{
				...
				public function getResourceListByNodeIDLimit( $NodeID, $Category, $start = 0, $offset = 15 )
				{
								global $table;
								global $db;
								global $iWPC;
				...
				public function getResourceNumByNodeID( $NodeID = 0, $Category = "img" )
				{
								global $table;
								global $db;
								if ( empty( $NodeID ) )
				...
				public function getQuoteContents( $ResourceID )
				{
								global $table;
								global $db;
								global $publish;
				...
				public function getResourceInfoByPath( $Path )
				{
								global $table;
								global $db;
				...
				public function delResourceByPath( $Path )
				{
								global $table;
								global $db;
								global $SYS_ENV;
				...
				public function delResourceRefByCollectionKey( $_ck )
				{
								global $table;
								global $db;
								global $SYS_ENV;
				...
				public function delResource( $ResourceID )
				{
								global $table;
								global $db;
								global $SYS_ENV;
