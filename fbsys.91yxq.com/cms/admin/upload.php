...
include_once INCLUDE_PATH.'encoding/encoding.inc.php';
include_once INCLUDE_PATH."admin/psn_admin.class.php";
include_once INCLUDE_PATH."admin/plugin.class.php";
include_once INCLUDE_PATH."admin/publishAuthAdmin.class.php";
include_once INCLUDE_PATH."admin/task.class.php";
include_once INCLUDE_PATH.'image.class.php';
include_once INCLUDE_PATH.'admin/upload.class.php';
include_once INCLUDE_PATH.'admin/TplVarsAdmin.class.php';
		...
		case 'img':
			if ($IN[mode] == 'single') {
				...
				if($IN['mkHTML'] == '1' && $IN[makeMini] == '1') {
					include_once INCLUDE_PATH."admin/publishAdmin.class.php";
					include_once INCLUDE_PATH."admin/content_table_admin.class.php";
					include_once INCLUDE_PATH."admin/tplAdmin.class.php";
					include_once INCLUDE_PATH."admin/psn_admin.class.php";
					include_once INCLUDE_PATH."cms.class.php";
					include_once INCLUDE_PATH."cms.func.php";
					include_once SETTING_DIR."upload.ini.php";
