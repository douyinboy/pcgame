...
/**
 * @description 通用注册入口
 * @注册接口  http://www.91yxq.com/cycs2/jujuwan/index.php?regid=64756544&adid=1
 */
	...
	$url = "http://api.91yxq.com/api/get_max_server_info.php?gid=21";
    $ch = curl_init();
	...
	switch ($adid) {
		case 1:
			$serverId = $serverId > 50 ? 0 : $serverId;
			break;
        default:
            $adid = 0;
    }
