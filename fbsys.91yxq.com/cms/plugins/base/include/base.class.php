...
class Base extends iData
{
				...
				public function getPublishRecordNum( $NodeID )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function getPublishRecordLimit( $NodeID, $start, $offset )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function getCommentRecordNum( $IndexID )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function getCommentRecordLimit( $IndexID, $start, $offset )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function getCommentInfo( $CommentID, $field = "*" )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function commentApprove( $CommentID )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function commentDelByTime( $_start_time, $_end_time )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function commentDelByIP( $_ip )
				{
								global $table;
								global $plugin_table;
								global $db_config;
				...
				public function commentDelByAuthor( $_author )
				{
								global $table;
								global $plugin_table;
								global $db_config;
