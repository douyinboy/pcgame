...
class contributionAdmin extends iData
{
				...
				public function approve( $NodeInfo, $ContributionID )
				{
								global $db_config;
								global $sys;
								global $IN;
				...
				public function del( $NodeInfo, $ContributionID )
				{
								global $table;
								global $db_config;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$NodeInfo[TableID];
				...
				public function callback( $NodeInfo, $ContributionID )
				{
								global $db_config;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$NodeInfo[TableID];
								$where = "where ContributionID=".$ContributionID;
				...
				public function addNote( $NodeInfo, $ContributionID, $callbackReason )
				{
								global $db_config;
								global $sys;
								global $table;
				...
				public function getContributionLimit( $NodeInfo, $start = 0, $offset = 15, $State = "!= -1" )
				{
								global $db;
								global $db_config;
								global $sys;
				...
				public function getContributionRecordNum( $NodeInfo, $State = "!= -1" )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function getPublishRecordNum( $NodeInfo, $State = "!= -1" )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function getContributionInfo( $NodeInfo, $ContributionID )
				{
								global $table;
								global $db;
								global $iWPC;
				...
				public function contributionEdit( $NodeInfo, $ContributionID )
				{
								global $db_config;
								global $iWPC;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$NodeInfo[TableID];
				...
				public function workflow( $OpID, $NodeInfo, $ContributionID )
				{
								global $db;
								global $table;
								global $db_config;
				...
				public function getNoteList( $NodeInfo, $ContributionID )
				{
								global $db;
								global $table;
								global $sys;
