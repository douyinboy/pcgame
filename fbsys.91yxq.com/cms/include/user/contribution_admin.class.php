...
class contributionUser extends iData
{
				...
				public function move( $ContributionID, $targetCateID, $CateInfo )
				{
								$this->flushData( );
				...
				public function copyTo( $IndexID, $targetCateID )
				{
								global $iWPC;
								global $sys;
				...
				public function createLink( $IndexID, $targetCateID )
				{
				...
				public function del( $CateInfo, $ContributionID )
				{
								global $db_config;
				...
				public function contribution( $CateInfo, $ContributionID )
				{
								global $db_config;
								global $iWPC;
								global $IN;
				...
				public function unContribution( $CateInfo, $ContributionID )
				{
								global $db_config;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$CateInfo[TableID];
								$where = "where ContributionID=".$ContributionID;
				...
				public function recordExists( $CateInfo, $fieldName, $fieldValue )
				{
								global $db_config;
								global $iWPC;
								global $db;
				...
				public function canContribution( $CateInfo, $ContributionID )
				{
								global $db_config;
								global $db;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$CateInfo[TableID];
				...
				public function canUnContribution( $CateInfo, $ContributionID )
				{
								global $db_config;
								global $db;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$CateInfo[TableID];
				...
				public function getContributionLimit( $CateInfo, $start = 0, $offset = 15, $State = "!= -1" )
				{
								global $db;
								global $db_config;
								global $sys;
				...
				public function getContributionRecordNum( $CateInfo, $State = "!= -1" )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function getContributionInfo( $CateInfo, $ContributionID, $field = "*" )
				{
								global $table;
								global $db;
								global $iWPC;
				...
				public function contributionEdit( $CateInfo, $ContributionID )
				{
								global $db_config;
								global $iWPC;
								$table_name = $db_config['table_pre'].$db_config['table_contribution_pre']."_".$CateInfo[TableID];
				...
				public function getNoteList( $CateInfo, $ContributionID )
				{
								global $db;
								global $table;
								global $sys;
				...
				public function getContributionLimitByNode( $NodeInfo, $start = 0, $offset = 15, $State = "!= -1" )
				{
								global $db;
								global $db_config;
								global $sys;
				...
				public function getContributionRecordNumByNode( $NodeInfo, $State = "!= -1" )
				{
								global $table;
								global $db;
								global $db_config;
