...
class content_table_admin extends iData
{
				...
				public function addTable( $TableID = 0 )
				{
								global $table;
								global $db_config;
								global $db;
				...
				public function getTableInfo( $TableID, $field = "*" )
				{
								global $table;
								global $db;
				...
				public function delTable( $TableID )
				{
								global $table;
								global $db_config;
								global $db;
				...
				public function addField( $TableID, $data, $_multiField = false )
				{
								global $table;
								global $db_config;
								global $db;
				...
				public function editField( $ContentFieldID, $data )
				{
								global $table;
								global $db_config;
								global $db;
				...
				public function indexField( $ContentFieldID )
				{
								global $table;
								global $db_config;
								global $db;
				...
				public function delFieldIndex( $ContentFieldID )
				{
								global $table;
								global $db_config;
								global $db;
				...
				public function _edit_field( $ContentFieldID )
				{
								global $table;
				...
				public function getFieldInfo( $ContentFieldID )
				{
								global $table;
								global $db;
				...
				public function delField( $ContentFieldID )
				{
								global $table;
								global $db;
								global $db_config;
				...
				public function _del_data( $ContentFieldID )
				{
								global $table;
				...
				public function OrderField( $Fields )
				{
				...
				public function EnableFieldListDisplay( $ContentFieldID, $display )
				{
								$this->flushData( );
				...
				public function EnableFieldSearch( $ContentFieldID, $searchable )
				{
								$this->flushData( );
				...
				public function EnableContribution( $ContentFieldID, $searchable )
				{
								$this->flushData( );
				...
				public function EnableCollection( $ContentFieldID, $searchable )
				{
								$this->flushData( );
				...
				public function EnablePublish( $ContentFieldID, $searchable )
				{
								$this->flushData( );
				...
				public function setAsMainField( $ContentFieldID, $TableID )
				{
								global $table;
								global $db;
								$this->flushData( );
				...
				public function setAsTitleField( $ContentFieldID, $TableID )
				{
								global $table;
								global $db;
								$this->flushData( );
