...
/**
 *http://api.demo.com/api/pc_egg/get_reward_by_api.php?merid=7778&user_name=allen&keycode=szdfgsd&gid=1
 */
...
switch ($game_id) {
    ...
    case 2:
        $server_id_arr = [4, 5, 6, 7];break;   //斗破沙城
    case 3:
        $server_id_arr = [5, 6, 7];break;   //热血虎卫
}
