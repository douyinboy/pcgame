...
class dsn_admin extends iData
{
				...
				public $deploy_table_comment = NULL;
				public $deploy_table_search = NULL;
				public $deploy_table_count = NULL;
				public $db = NULL;
				...
				public function getDSNInfo( $DSNID )
				{
								global $table;
								global $db;
...
class dbDeploy extends kData
{
				...
				public function connectTo( $DSNID, $TableID )
				{
								global $db_config;
								global $db;
				...
				public function isCountExists( $IndexID )
				{
				...
				public function editField( $fieldInfo, $data )
				{
								global $db_config;
								if ( $data[FieldSize] != "" && $data[FieldType] != "text" && $data[FieldType] != "mediumtext" && $data[FieldType] != "longtext" )
								{
				...
				public function delField( $fieldInfo )
				{
								global $db_config;
				...
				public function deleteIndex( $fieldInfo )
				{
								global $db_config;
