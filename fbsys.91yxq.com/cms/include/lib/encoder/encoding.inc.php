...
class Encoding
{
				...
				public function SetGetEncoding( $GetEncoding )
				{
								$order = 0;
				...
				public function GBKToUnicode( &$String )
				{
				...
				public function BIGToUnicode( &$String )
				{
				...
				public function UnicodeToGBK( &$String )
				{
				...
				public function UnicodeToBIG( &$String )
				{
				...
				public function UnicodeToUTF( &$String )
				{
								$len = strlen( $String );
								$ReturnString = "";
								$x = 0;
				...
				public function ChangeByte( &$String )
				{
								$len = strlen( $String );
								$ReturnString = "";
								$i = 0;
				...
				public function UTFToUnicode( &$String )
				{
				...
				public function CheckEncoding( $Encoding, &$order )
				{
								$order = 0;
