...
function movediv(url,title,css,cajax,scrolling,top,left,cssid){
	...
	gID(cssid).innerHTML = '<div id="movediv_">'+
		'<div class="movediv clear" onmousedown="canmove(document.getElementById(\'movediv_\'),event)">'+
				...
				'<div style="float: right;cursor:pointer;height:25px;margin-top:5px;margin-right:3px;width:21px;text-align:right;" title="关闭" onClick="logoutdiv();"><img src="http://image.6qwan.com/index/close.jpg" width="21" height="21" \/><\/div>'+
		'<\/div>'+
		infos+
	'<\/div>';
