...
/**
 * @description 通用注册入口
 * @注册接口  http://www.91yxq.com/mhzn2/bengbeng/index.php?annalID=67235354&adid=16083
 */
    ...
    switch ($adid) {
    	case 15951:
    		...
    		break;
    	case 16083:
    		$serverId = $serverId > 10 ? 0 : $serverId;
    		break;
		default:
			$adid = 0;
	}
		...
		<div class="container">
			<div class="bd">
				<div class="inner">
                    ...
                    <form action="http://www.91yxq.com/main.php?act=reg_bengbeng" method="post">
