...
class Error
{
				...
				public function handler( $no, $str, $file, $line, $ctx )
				{
				...
				public function _printStackTrace( )
				{
								switch ( $this->displayErrorMode )
								{
								case "js" :
				...
				public function raiseError( $msg, $no = E_USER_WARNING )
				{
