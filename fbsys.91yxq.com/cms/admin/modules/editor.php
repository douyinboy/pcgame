...
//考虑小键盘上的数字键
    ...
    function InputPicker(action, form, element) {
        ...
        switch (action) {
            case 'color':
                var arr = showMeDialog("ui.php?sId=<?=$IN['sId']?>&o=editor__color.htm", "color", "dialogWidth:267px;dialogHeight:234px;help:0;status:0");
                break;
            case 'date':
...
<script type="text/javascript">
    ...
    Calendar._TT["PREV_YEAR"] = "<?= $_LANG_SKIN['Last_year']; ?>  ";
    Calendar._TT["PREV_MONTH"] = "<?= $_LANG_SKIN['Last_month']; ?>  ";
    Calendar._TT["GO_TODAY"] = "<?= $_LANG_SKIN['Today']; ?>";
    Calendar._TT["NEXT_MONTH"] = "<?= $_LANG_SKIN['Next_month']; ?>  ";
    Calendar._TT["NEXT_YEAR"] = "<?= $_LANG_SKIN['Next_year']; ?>  ";
    Calendar._TT["SEL_DATE"] = "<?= $_LANG_SKIN['select_date']; ?>";
    Calendar._TT["DRAG_TO_MOVE"] = "Drag to move";
    Calendar._TT["PART_TODAY"] = " <?= $_LANG_SKIN['Today1']; ?>";
    Calendar._TT["MON_FIRST"] = "Display Monday first";
    Calendar._TT["SUN_FIRST"] = "Display Sunday first";
    Calendar._TT["CLOSE"] = "<?= $_LANG_SKIN_GLOBAL['close']; ?>";
    Calendar._TT["TODAY"] = "<?= $_LANG_SKIN['Today']; ?>";
</script>
<script type="text/javascript">
...
<form action="admin_publish.php?sId=<?= $IN['sId'] ?>&type=main&o=<?= $IN['o'] ?>_submit&NodeID=<?= $IN['NodeID'] ?>&IndexID=<?= $pInfo['IndexID'] ?>" method="post" name="FM">
    <!--actionFrame-->
    ...
    <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0 bgcolor="#D6D3CE">
        ...
        <TR>
            <TD>
                ...
                UNSELECTABLE="on" title="<?= $_LANG_SKIN['main_content_help']; ?>"><label><?= $_LANG_SKIN['main_content']; ?></label></TD>
                                        ...
                                        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                                            ...
                                            <TR>
                                                ...
                                                <TD class=tab id=tabLabel__1 onclick=tabClick(1)
                                                    background="../html/images/mpc/tab_active_bg.gif"
                                                    UNSELECTABLE="on"><label><?= $_LANG_SKIN['base_content']; ?></label></TD>
                                        ...
                                        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                                            ...
                                            <TR>
                                                ...
                                                <TD class=tab id=tabLabel__2 onclick=tabClick(2)
                                                    ...
                                                    UNSELECTABLE="on" TITLE="<?= $_LANG_SKIN['publish_setting_help']; ?>"><label><?= $_LANG_SKIN['publish_setting']; ?></label></TD>
                                        ...
                                        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                                            ...
                                            <TR>
                                                ...
                                                <TD class=tab id=tabLabel__3 onclick=tabClick(3)
                                                    background="../html/images/mpc/tab_unactive_bg.gif"
                                                    UNSELECTABLE="on"><label><?= $_LANG_SKIN['publish_resources']; ?></label></TD>
                                    ...
                                    <TD
                                        ...
                                        <DIV id=tabContent__1 style=" VISIBILITY: visible">
                                            <table border=0 width=100% cellPadding=5 cellSpacing=0>
                                                ...
                                                if ($tableInfo[0]['TableID'] == 6 || $tableInfo[0]['TableID'] == 7) {//开服列表模型、推广游戏模型

                                                    /*** 选择平台 改变游戏列表 js  2011-06-07 ***/
                                                    ?>
                                                    <script type="text/javascript" src="http://image.91yxq.com/js/jquery-1.10.2.min.js"></script>
                                                    <script language="javascript">
                                                        function get_game(pid) {
                                                            $.ajax(
                                                                {
                                                                    type: "POST",
                                                                    url: "<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], '', dirname(str_replace('\\', '/', realpath(ROOT_PATH))));?>/api/get_gamelist.php",
                                                                    data: "gtype=set&PlatformId=" + pid,
                                                ...
                                                /*** 获取三个平台的游戏列表 2011-06-07  ***/

                                                /*** end ***/
                                                }
                                                elseif ($tableInfo[0]['TableID'] == 5){//游戏列表模型
                                                ?>
                                                    <script type="text/javascript" src="http://image.91yxq.com/js/jquery-1.10.2.min.js"></script>
                                                    <?php
                                                }
...
// echo "</pre>";
                                                    ...
                                                    if (($var[FieldInput] == 'text' || $var[FieldInput] == 'textaera' || $var[FieldInput] == 'RichEditor') && $var[FieldInputPicker] != 'url_content' && ($IN[o] == 'add' || $IN[o] == 'edit') && !empty($var[FieldInputTpl])) {
                                                    ...
                                                    echo "<tr class='tablelist'><td align=right  width=80>{$var[FieldTitle]}:</td>"; //** <td valign='middle'>";
                                                    if ($var['FieldName'] == 'GameId') {
                                                        echo "<td valign='middle' id='gamelist'>";
                                                    } else {
...
// 			print_r($resultDSN->fields);
                                                    ...
                                                    if ($var[FieldInput] == 'text' && $var[FieldType] != 'contentlink') { //单行文本
                                                        ...
                                                        $tempInputValue = null;
                                                        if (isset($pInfo[$var['FieldName']])) {
                                                            $tempInputValue = htmlspecialchars($pInfo[$var['FieldName']]);
                                                        } elseif (isset($var['FieldDefaultValue'])) {
                                                            $tempInputValue = htmlspecialchars($var['FieldDefaultValue']);
                                                        }
                                                        if ($var['FieldInputFilter'] == 'num_letter') {
                                                            echo "<input name='data_{$var[FieldName]}' type='text' value=\"{$tempInputValue}\" style='width:60%;'      onkeyup=\"value=value.replace(/[\W]/g,'') \" onbeforepaste=\"clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))\" />";

                                                        } elseif ($var[FieldInputFilter] == 'num') {
                                                            echo "<input name='data_{$var[FieldName]}' type='text' value=\"{$tempInputValue}\" style='width:60%;' onkeydown=\"onlyNum();\" />";

                                                        } elseif ($var[FieldInputPicker] == 'date') {
                                                            echo "<input name='data_{$var[FieldName]}' id='data_{$var[FieldName]}' type='text' value=\"{$tempInputValue}\" style='width:60%;' onclick=\"FieldInputTpl='{$var[FieldInputTpl]}';FieldDefaultValue='{$var[FieldDefaultValue]}';InputPicker('{$var[FieldInputPicker]}',this.form,'data_{$var[FieldName]}')\" />";

                                                        } else {
                                                            echo "<input name='data_{$var[FieldName]}' type='text' value=\"{$tempInputValue}\" style='width:60%;' />";

                                                        }

                                                        if ($var[FieldDescription]) {
                                                            echo '备注：' . $var[FieldDescription];
                                                        }
                                                        ...
                                                        if ($var[FieldInputFilter] == 'num_letter') {
                                                            echo "<textarea name='data_{$var[FieldName]}' class='button' id='{$var[FieldName]}' style='vertical-align: middle;width:60%;overflow:auto; background-color:#FFFFFF;' rows='5' onkeyup=\"value=value.replace(/[\W]/g,'') \" onbeforepaste=\"clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))\">{$tempInputValue}</textarea>";

                                                        } elseif ($var[FieldInputFilter] == 'num') {
                                                            echo "<textarea name='data_{$var[FieldName]}' class='button' id='{$var[FieldName]}' style='vertical-align: middle;width:60%;overflow:auto; background-color:#FFFFFF;' rows='5' onkeydown=\"onlyNum();\">{$tempInputValue}</textarea>";

                                                        } else {
                                                            echo "<textarea name='data_{$var[FieldName]}' class='button' id='{$var[FieldName]}' style='vertical-align: middle;width:60%;overflow:auto; background-color:#FFFFFF;' rows='5'>{$tempInputValue}</textarea>";
                                                        ...
                                                        /***
                                                         * 选择平台 改变游戏列表  2011-06-07
                                                         * echo "<select name='data_{$var[FieldName]}'>";
                                                         ***/
                                                        echo "<select name='data_{$var[FieldName]}' ";
                                                        if ($var['FieldName'] == 'PlatformId') {
                                                            echo "onchange='get_game(this.value);' ";
                                                        } elseif ($var['FieldName'] == 'GameType') {
                                                            echo 'onchange="$(\'select[name=data_GameTypeId]\').get(0).selectedIndex=this.selectedIndex;"';
                                                        } elseif ($var['FieldName'] == 'GameTypeId') {
                                                            echo 'onchange="$(\'select[name=data_GameType]\').get(0).selectedIndex=this.selectedIndex;"';
                                                        } elseif ($var['FieldName'] == 'GameTheme') {
                                                            echo 'onchange="$(\'select[name=data_GameThemeId]\').get(0).selectedIndex=this.selectedIndex;"';
                                                        } elseif ($var['FieldName'] == 'GameThemeId') {
                                                            echo 'onchange="$(\'select[name=data_GameTheme]\').get(0).selectedIndex=this.selectedIndex;"';
                                                        } elseif ($var['FieldName'] == 'GameInitial') {
                                                            echo 'onchange="$(\'select[name=data_GameInitialId]\').get(0).selectedIndex=this.selectedIndex;"';
                                                        } elseif ($var['FieldName'] == 'GameInitialId') {
                                                            echo 'onchange="$(\'select[name=data_GameInitial]\').get(0).selectedIndex=this.selectedIndex;"';
                                                        }

                                                        echo ">";
                                                        /*** end ***/

                                                        if ($tableInfo[0][TableID] == 1) {
                                                            if ($var['FieldName'] == 'GameId') {
                                                                /*** 根据平台选择对应的游戏列表 2011-06-07 ***/
                                                                //$platfo#rm_id>0?$game_str="game_arr".$platfo#rm_id:$game_str="game_arr1";
                                                                //
                                                                require_once dirname(realpath(ROOT_PATH)) . '/api/get_gamelist.php';
                                                                $pInfo['PlatformId'] = $pInfo['PlatformId'] > 0 ? $pInfo['PlatformId'] : 1;
                                                                foreach ($game_arr[$pInfo['PlatformId']] as $key => $val) {
                                                                    if ($pInfo['GameId'] == $key) {
                                                            ...
                                                            } elseif ($var['FieldName'] == 'PlatformId') {
                                                                $PlatformId = $pInfo['PlatformId'];
                                                                $platform_arr = include(dirname(realpath(ROOT_PATH)) . '/api/platformDefined.php');
                                                            ...
                                                            } elseif ($var['FieldName'] == 'NewsType') {
                                                                $NewsType = [1 => '新手指南', 2 => '高手进阶', 3 => '游戏系统', 4 => '特色玩法', 5 => '新闻', 6 => '公告', 7 => '活动', 8 => '游戏截图', 9 => '游戏攻略', 10 => '滚屏公告'];
                                                                foreach ($NewsType as $key => $val) {
                                                                    if ($pInfo['NewsType'] == $key) {
                                                                        echo "<option value='{$key}' selected>{$val}</option>";
                                                                    } else {
                                                                        echo "<option value='{$key}'>{$val}</option>";
                                                                    }
                                                        ...
                                                        //if($tableInfo[0][TableID]==7 || $tableInfo[0][TableID]==12 || $tableInfo[0][TableID]==23 || $tableInfo[0][TableID]==24){ //开服列表模型
                                                        if ($tableInfo[0][TableID] == 5 || $tableInfo[0][TableID] == 6 || $tableInfo[0][TableID] == 7) { //游戏列表模型 、 开服列表模型 、 推广游戏模型
                                                            if ($var['FieldName'] == 'ServerShow') {
                                                                $ServerShowArr = array('全部隐藏', '仅游戏官网显示', '仅平台显示', '全部显示');
                                                                foreach ($ServerShowArr as $key => $val) {
                                                                    if ($pInfo['ServerShow'] == $key) {
                                                                        echo "<option value='{$key}' selected>{$val}</option>";
                                                                    } else {
                                                                        echo "<option value='{$key}'>{$val}</option>";
                                                                    }
                                                            ...
                                                            } elseif ($var['FieldName'] == 'ServerStatus') {
                                                                $ServerStatusArr = array('停服', '维护', '待开', '顺畅', '火爆', '爆满');
                                                                foreach ($ServerStatusArr as $key => $val) {
                                                                    if ($pInfo['ServerStatus'] == $key) {
                                                                        echo "<option value='{$key}' selected>{$val}</option>";
                                                                    } else {
                                                                        echo "<option value='{$key}'>{$val}</option>";
                                                                    }
                                                                }
                                                            } elseif ($var['FieldName'] == 'GameId') {
                                                                /*** 根据平台选择对应的游戏列表 2011-06-07 ***/
                                                                //$platfo#rm_id>0?$game_str="game_arr".$platfo#rm_id:$game_str="game_arr1";
                                                                //
                                                                require_once dirname(realpath(ROOT_PATH)) . '/api/get_gamelist.php';
                                                            ...
                                                            } elseif ($var['FieldName'] == 'GameTag') {
                                                                $gameTags = array('无', '最新', '火爆', '推荐');
                                                                foreach ($gameTags as $key => $val) {
                                                                    if ($pInfo['GameTag'] == $key) {
                                                                        echo "<option value='{$key}' selected>{$val}</option>";
                                                                    } else {
                                                                        echo "<option value='{$key}'>{$val}</option>";
                                                                    }
                                                                ...
                                                                require_once dirname(realpath(ROOT_PATH)) . '/api/get_gametype.php';
                                                                echo "<option value='未分类' selected>未分类</option>";
                                                                foreach ($gametype_list as $key => $val) {
                                                                    if ($pInfo['GameType'] == $val['DataValue']) {
                                                                        echo "<option value='" . $val['DataValue'] . "' selected>" . $val['DataValue'] . "</option>";
                                                                    } else {
                                                                        echo "<option value='" . $val['DataValue'] . "'>" . $val['DataValue'] . "</option>";
                                                                    }
                                                                }
                                                            } elseif ($var['FieldName'] == 'GameTypeId') {
                                                                require_once dirname(realpath(ROOT_PATH)) . '/api/get_gametype.php';
                                                                echo "<option value='0' selected>0 - (未分类)</option>";
                                                                foreach ($gametype_list as $key => $val) {
                                                                    if ($pInfo['GameTypeId'] == $val['DataId']) {
                                                                        echo "<option value='{$val['DataId']}' selected>{$val['DataId']} - ({$val['DataValue']})</option>";
                                                                    } else {
                                                                        echo "<option value='{$val['DataId']}'>{$val['DataId']} - ({$val['DataValue']})</option>";
                                                                    }
                                                                }
                                                            } elseif ($var['FieldName'] == 'GameTheme') {
                                                                require_once dirname(realpath(ROOT_PATH)) . '/api/get_gametheme.php';
                                                                echo "<option value='未分类' selected>未分类</option>";
                                                                foreach ($gametheme_list as $key => $val) {
                                                                    if ($pInfo['GameTheme'] == $val['DataValue']) {
                                                                        echo "<option value='" . $val['DataValue'] . "' selected>" . $val['DataValue'] . "</option>";
                                                                    } else {
                                                                        echo "<option value='" . $val['DataValue'] . "'>" . $val['DataValue'] . "</option>";
                                                                    }
                                                                ...
                                                                echo "<option value='0' selected>0 - (未分类)</option>";
                                                                foreach ($gametheme_list as $key => $val) {
                                                                    if ($pInfo['GameThemeId'] == $val['DataId']) {
                                                                        echo "<option value='{$val['DataId']}' selected>{$val['DataId']} - ({$val['DataValue']})</option>";
                                                                    } else {
                                                                        echo "<option value='{$val['DataId']}'>{$val['DataId']} - ({$val['DataValue']})</option>";
                                                                    }
                                                                ...
                                                                require_once dirname(realpath(ROOT_PATH)) . '/api/get_gameinitial.php';
                                                                echo "<option value='未分类' selected>未分类</option>";
                                                                foreach ($gameinitial_list as $key => $val) {
                                                                    if ($pInfo['GameInitial'] == $val['DataValue']) {
                                                                        echo "<option value='" . $val['DataValue'] . "' selected>" . $val['DataValue'] . "</option>";
                                                                    } else {
                                                                        echo "<option value='" . $val['DataValue'] . "'>" . $val['DataValue'] . "</option>";
                                                                    }
                                                                ...
                                                                echo "<option value='0' selected>0 - (未分类)</option>";
                                                                foreach ($gameinitial_list as $key => $val) {
                                                                    if ($pInfo['GameInitialId'] == $val['DataId']) {
                                                                        echo "<option value='{$val['DataId']}' selected>{$val['DataId']} - ({$val['DataValue']})</option>";
                                                                    } else {
                                                                        echo "<option value='{$val['DataId']}'>{$val['DataId']} - ({$val['DataValue']})</option>";
                                                                    }
                                        ...
                                        <DIV id=tabContent__2 style="DISPLAY: none; VISIBILITY: hidden">
                                            <table border=0 cellPadding=0 cellSpacing=5>
                                                <?php if ($IN[o] == 'add'): ?>
                                                    <tr class='tablelist'>
                                                        <td align=right><?= $_LANG_SKIN['create_link']; ?></td>
                                                        <td valign=top>
                                                            <table>
                                                                <tr>
                                                                    <td><?= $_LANG_SKIN['create_solid_link']; ?></td>
                                                                    <td><?= $_LANG_SKIN['create_index_link']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <select name="SubTargetNodeID[]" id="SubTargetNodeID" size="10" multiple>
                                                                            <option value=''><?= $_LANG_SKIN['null']; ?></option>
                                                                            <?php
                                                ...
                                                <?php endif; ?>
                                                <tr class='tablelist'>
                                                    <td align=right><?= $_LANG_SKIN['publish_date']; ?>:</td>
                                                    <td>
                                                        <input name="year" type="text" class="button" id="dTime" onFocus="return showCalendar('dTime', 'y-mm-dd');"
                                                               value="<?= $output_year ?>">
                                                        <select name="hour">
                                                            <?= $output_hour ?>
                                                        ...
                                                        <?= $_LANG_SKIN['minute']; ?> <select name="second">
                                                            <?= $output_second ?>
                                                ...
                                                <!--
<tr class='tablelist'>
              <td align=right ><?= $_LANG_SKIN['sort_height']; ?>:</td>
              <td >
<input name="Sort" type="text" class="button" id="Sort"    value="<?= $pInfo['Sort'] ?>">
                                                ...
                                                <tr class='tablelist'>
                                                    <td align=right><?= $_LANG_SKIN['top_height']; ?>:</td>
                                                    <td>
                                                ...
                                                <tr class='tablelist'>
                                                    <td align=right><?= $_LANG_SKIN['pink_height']; ?>:</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td align=right><?= $_LANG_SKIN['self_template']; ?>:</td>
                                                    <td><input name='SelfTemplate' id="SelfTemplate" type='text' value='<?= $pInfo['SelfTemplate'] ?>' size=80%>&nbsp;<input
                                                                name="button5" type='button' tabindex='13' value='...' onclick="InputPicker('tpl',this.form,'SelfTemplate')"></td>
                                                </tr>

                                                <tr>
                                                    <td align=right><?= $_LANG_SKIN['self_publish_name']; ?>:</td>
                                                    <td><input name='SelfPublishFileName' id="SelfPublishFileName" type='text' value='<?= $pInfo['SelfPublishFileName'] ?>'
                                                               size=80%></td>
                                                </tr>

                                                <tr>
                                                    <td align=right><?= $_LANG_SKIN['self_psn']; ?>:</td>
                                                    <td><input name='SelfPSN' id="SelfPSN" type='text' value='<?= $pInfo['SelfPSN'] ?>' size=80%>&nbsp; <input name="button6"
                                                                                                                                                               type='button'
                                                                                                                                                               tabindex='13'
                                                                                                                                                               value='...'
                                                                                                                                                               onclick="psnSelect('<?= $pInfo['SelfPSN'] ?>',this.form,'SelfPSN','SelfPSNURL')">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align=right><?= $_LANG_SKIN['self_psn_url']; ?> :</td>
                                                    <td><input name='SelfPSNURL' id="SelfPSNURL" type='text' value='<?= $pInfo['SelfPSNURL'] ?>' size=80%>&nbsp; </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align=right><?= $_LANG_SKIN['self_url']; ?> :</td>
                                                    <td><input name='SelfURL' id="SelfURL" type='text' value='<?= $pInfo['SelfURL'] ?>' size=80%>&nbsp; </td>
                                                </tr>
                                            </table>
                                        </DIV>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (!empty($imgResourceInfo)) : ?>
                                                            ...
                                                            <fieldset class="search">
                                                                <legend><b><?= $_LANG_SKIN['photo']; ?></b></legend>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="imagespacer">
                                                                                <div class="imageholder">
                                                                                    <A HREF="<?= $SYS_ENV['ResourcePath'] ?>/<?= $var['Path'] ?>" target="_blank"><img
                                                                                                src="automini.php?sId=<?= $IN['sId'] ?>&src=<?php echo urlencode($SYS_ENV['ResourcePath'] . "/" . $var['Path']); ?>&pixel=160*120&cache=1&cacheTime=1000"
                                                        ...
                                                        <?php if (!empty($attachResourceInfo)) : ?>
                                                            <fieldset class="search">
                                                                <legend><b><?= $_LANG_SKIN['attach']; ?></b></legend>
                                                                <table border="0" cellpadding="3" cellspacing="0">
                                                                    <?php foreach ($attachResourceInfo as $key => $var): ?>
                                                                        <tr>
                                                                            <td>
                                                                                <?php preg_match("/\.([a-zA-Z0-9]+)$/isU", $var['Path'], $match); ?>
                                                                                <IMG src="<?php echo $PUBLISH_URL; ?>/images/icon/<?= $match[1] ?>.gif" border=0></td>
                                                                            <td>
                                                        ...
                                                        <?php if (!empty($flashResourceInfo)) : ?>
                                                            <fieldset class="search">
                                                                <legend><b><?= $_LANG_SKIN['Flash']; ?></b></legend>
                                                                <table border="0" cellpadding="3" cellspacing="0">
