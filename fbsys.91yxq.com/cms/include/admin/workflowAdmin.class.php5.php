...
class workflowAdmin extends iData
{
				...
				public function edit_record( $OpID )
				{
								global $table;
				...
				public function del_record( $OpID )
				{
								global $table;
								$which = "OpID";
				...
				public function getAllRecord( $wID )
				{
								global $table;
								global $db;
								if ( empty( $wID ) )
				...
				public function getAllWorkFlowRecordByGroup( $wID, $gId )
				{
								global $table;
								global $db;
								if ( $gId == "admin" )
				...
				public function getAllStateByGroup( $wID, $gId )
				{
								global $table;
								global $db;
								if ( $gId == "admin" )
				...
				public function getStateInfo( $ID, $field = "*" )
				{
								global $table;
								global $db;
				...
				public function getRecordInfo( $OpID, $field = "*" )
				{
								global $table;
								global $db;
				...
				public function getRecordInfoByStateBeforeOp( $wID, $State, $field = "*" )
				{
								global $table;
								global $db;
				...
				public function getInfo( $wID, $field = "*" )
				{
								global $table;
								global $db;
