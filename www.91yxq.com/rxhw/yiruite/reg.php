...
/**
 * @description 通用注册入口
 * @注册接口  http://www.91yxq.com/rxhw/yiruite/reg.php?tid=64204685&adid=1
 */
if (empty($_GET['tid']) || empty($_GET['adid'])) {
    exit('All the parameters can not be empty!');
}
$pcid = $_GET['tid'];
$adid = $_GET['adid'];

$url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=3&agent_id=10032&adid=".$adid;
$ch = curl_init();
    ...
    <div class="container">
        ...
        <div class="bd">
            <div class="inner">
                ...
                <form action="http://www.91yxq.com/main.php?act=reg_yiruite" method="post">
                    ...
                    <input type="hidden" name="agent_id" value="10032" />
                    <input type="hidden" name="placeid" value="10109" />
