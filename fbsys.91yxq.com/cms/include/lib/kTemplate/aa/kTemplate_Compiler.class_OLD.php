...
class kTemplate_Compiler extends kTemplate
{
				...
				public function kTemplate_Compiler( $params = NULL )
				{
				...
				public function db( &$file_name )
				{
								list( $tId, $tName ) = explode( "@", $file_name );
								return tplAdmin::gettplcontent( $tId );
				}

				public function makeDir( $directory, $mode = 511 )
				{
				...
				public function templateExists( $file_name )
				{
				...
				public function compile( $file_name, $compile_name = NULL )
				{
				...
				public function _compile_file( $contents )
				{
				...
				public function _compile_php( &$contents )
				{
								$patt = "'<php>(.*)</php>'siU";
				...
				public function parse_lang( &$contents )
				{
				...
				public function parse_lang_php( &$contents )
				{
								$patt = "/#lang:([a-zA-Z0-9_\\-]+)#/siU";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function lang_php_tag_format( $var )
				{
								$var = "\$_LANG_SKIN['{$var}']";
								return $var;
				}

				public function lang_php_global_tag_format( $var )
				{
								if ( strpos( $var, " " ) )
								{
												$vars = explode( " ", $var );
				...
				public function lang_tag_format( $var )
				{
								$var = "<?php echo \$_LANG_SKIN['{$var}'];?>";
								return $var;
				}

				public function lang_global_tag_format( $var )
				{
								if ( strpos( $var, " " ) )
								{
												$vars = explode( " ", $var );
				...
				public function parse_tag( $contents )
				{
				...
				public function parse_tag_format_var( $string )
				{
				...
				public function parse_tag_format_var2( $string )
				{
								$header = "\$this->_tpl_vars";
								if ( strpos( $string, "." ) )
								{
				...
				public function parse_tag_format_varIN( $string )
				{
								$header = "{\$this->_tpl_vars";
				...
				public function parse_tag_format_display( $string )
				{
				...
				public function parse_tag_format_global_var( $string )
				{
								$header = "{\$GLOBALS";
								if ( strpos( $string, "." ) )
								{
				...
				public function parse_tag_format_global_display( $string )
				{
				...
				public function _parseParameterPlus( $Parameter )
				{
				...
				public function parse_meta( &$contents )
				{
				...
				public function parse_php( &$contents )
				{
								$patt = "'<php>(.*)</php>'siU";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function parse_if( &$contents )
				{
								$patt = "'<if[\\s]+([^\n]+)>'si";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function parse_if_cmsware3( &$contents )
				{
								$patt = "'<if[\\s]+test=\"([^\"]+)\"[\\s]*>'si";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function format_var( $data )
				{
								$patt = "/([^[]?)\\\$([a-zA-Z0-9_\\-\\.\$:]+)/";
				...
				public function format_control_local( $string )
				{
								$header = "\$this->_tpl_vars";
								if ( strpos( $string, "." ) )
								{
				...
				public function format_control_global( $string )
				{
								$header = "\$GLOBALS";
								if ( strpos( $string, "." ) )
								{
				...
				public function parse_loop( &$contents )
				{
				...
				public function parse_loop_cmsware3( &$contents )
				{
								$patt = "'<loop[\\s]+(.*)>'siU";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function _parseAttribute( $Parameter )
				{
				...
				public function clear_comment( $contents )
				{
								return preg_replace( "/<!--#CW#(.*)#CW#-->/isU", "", $contents );
				}

				public function parse_include_subtpl( $contents )
				{
				...
				public function parse_include( $contents )
				{
				...
				public function path2name( $string )
				{
				...
				public function parse_include_format( $string )
				{
				...
				public function parse_get( $contents )
				{
				...
				public function parse_get_format( $string )
				{
				...
				public function parse_var( &$contents )
				{
								$patt = "/<var[\\s]*(.*)[\\s]*[\\/]?>/siU";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function parse_op( &$contents )
				{
								$patt = "/<op[\\s]+exp=\"([^\n]*)\"[\\s]*[\\/]?>/si";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function parse_debug( &$contents )
				{
								$patt = "/<debug[\\s]+name=\"([^\"\n]*)\"[\\s]*[\\/]?>/si";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function parse_xml( &$contents )
				{
								$patt = "/<\\?xml(.*)\\?>/siU";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
				...
				public function parse_header( &$contents )
				{
				...
				public function _parseParameter( $Parameter )
				{
								$Parameter = trim( $Parameter );
								$patt = "/([A-Za-z0-9_\\-]+)=[\"\\']([^\"\\']*)[\"\\']/siU";
				...
				public function _parseRawParameter( $Parameter )
				{
								$Parameter = trim( $Parameter );
								$patt = "/([A-Za-z0-9_\\-]+)=[\"\\']([^\"\\']*)[\"\\']/siU";
								if ( preg_match_all( $patt, $Parameter, $matches ) )
				...
				public function parse_tag_func( $contents )
				{
				...
				public function parse_tag_func_format( $funName, $params )
				{
								$header = "<?php echo ";
								$patt = "/\\\$([a-zA-Z0-9_\\-\\.]+)/si";
				...
				public function parse_html_tag_select( $contents )
				{
				...
				public function parse_html_tag_input_radio( $contents )
				{
				...
				public function parse_literal_encode( $contents )
				{
				...
				public function parse_literal_decode( $contents )
				{
								$patt = "/<literal>(.*)<\\/literal>/siU";
								if ( preg_match_all( $patt, $contents, $matches ) )
								{
