<?php
/**
 * http://www.91yxq.com/cycs2/kuailezhuan/index.php?leID=245&adID=14134
 */
	if (empty($_GET['leID']) || empty($_GET['adID'])) {
		exit('所有参数均不能为空!');
	}
	$pcid = $_GET['leID'];
	$adid = $_GET['adID'];

    $url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=21&agent_id=10015&adid=14134";
	$ch = curl_init();
		...
		<div class="container">
			<div class="bd">
				<div class="inner">
                    ...
                    <form action="http://www.91yxq.com/main.php?act=reg_kuailezhuan" method="post">
                        ...
                        <input type="hidden" name="agent_id" value="10015" />
						<input type="hidden" name="placeid" value="10074" />
