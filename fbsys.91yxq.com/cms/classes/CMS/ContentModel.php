...
class CMS_ContentModel extends content_table_admin
{
				...
				public $ContentModelReservedFieldName = array
				(
								0 => "IndexID",
								1 => "ContentID",
								2 => "NodeID",
				...
				public function CMS_ContentModel( )
				{
				}

				public function import( $_content )
				{
								$TableData = $this->parseContentTableXML( $_content );
								return $this->_import( $TableData );
				}

				public function importFromFile( $_file )
				{
								$TableData = $this->parseContentTableXMLFile( $_file );
								return $this->_import( $TableData );
				}

				public function _import( &$TableData )
				{
								if ( !empty( $TableData ) )
								{
												$this->flushData( );
				...
				public function parseContentTableXMLFile( $_file )
				{
				...
				public function parseContentTableXML( $content )
				{
