<?php
/**
 * @注册接口  http://www.91yxq.com/cycs2/ledouwan/reg.php?luid=209795&lwid=2636&ltype=pagegame
 */
...
$url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=21&agent_id=10028&adid=".$adid;
$ch = curl_init();
