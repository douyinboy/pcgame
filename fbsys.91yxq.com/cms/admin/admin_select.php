...
function getTextWidth($str){
	$textWidth = 0;
	$filenameLength = strlen($str);
	for( $i=0;$i<$filenameLength;$i++ ){
		switch($str[$i]){
			case 'A':$textWidth+=8;break;
			case 'B':$textWidth+=7;break;
			case 'C':$textWidth+=7;break;
			case 'D':$textWidth+=8;break;
			case 'E':$textWidth+=7;break;
			case 'F':$textWidth+=6;break;
			case 'G':$textWidth+=8;break;
			case 'H':$textWidth+=8;break;
			case 'I':$textWidth+=4;break;
			case 'J':$textWidth+=5;break;
			case 'K':$textWidth+=7;break;
			case 'L':$textWidth+=6;break;
			case 'M':$textWidth+=9;break;
			case 'N':$textWidth+=8;break;
			case 'O':$textWidth+=9;break;
			case 'P':$textWidth+=7;break;
			case 'Q':$textWidth+=9;break;
			case 'R':$textWidth+=7;break;
			case 'S':$textWidth+=7;break;
			case 'T':$textWidth+=8;break;
			case 'U':$textWidth+=8;break;
			case 'V':$textWidth+=8;break;
			case 'W':$textWidth+=12;break;
			case 'X':$textWidth+=7;break;
			case 'Y':$textWidth+=8;break;
			case 'Z':$textWidth+=7;break;
			case 'a':$textWidth+=6;break;
			case 'b':$textWidth+=7;break;
			case 'c':$textWidth+=6;break;
			case 'd':$textWidth+=7;break;
			case 'e':$textWidth+=7;break;
			case 'f':$textWidth+=4;break;
			case 'g':$textWidth+=7;break;
			case 'h':$textWidth+=7;break;
			case 'i':$textWidth+=2;break;
			case 'j':$textWidth+=3;break;
			case 'k':$textWidth+=6;break;
			case 'l':$textWidth+=2;break;
			case 'm':$textWidth+=10;break;
			case 'n':$textWidth+=7;break;
			case 'o':$textWidth+=7;break;
			case 'p':$textWidth+=7;break;
			case 'q':$textWidth+=7;break;
			case 'r':$textWidth+=4;break;
			case 's':$textWidth+=5;break;
			case 't':$textWidth+=5;break;
			case 'u':$textWidth+=7;break;
			case 'v':$textWidth+=6;break;
			case 'w':$textWidth+=10;break;
			case 'x':$textWidth+=6;break;
			case 'y':$textWidth+=6;break;
			case 'z':$textWidth+=5;break;
			case '.':$textWidth+=4;break;
			case '-':$textWidth+=4;break;
			case '_':$textWidth+=7;break;
		}
	}
	return $textWidth;
}
...
switch($IN[o]) {
	...
	case 'tpl_list_file':
		...
		foreach($fileList as $key=>$var) {
			...
			$filenameWidth = getTextWidth($var['name']);
			if($filenameWidth > $finalWidth ) $finalWidth  = $filenameWidth;
		...
		$TPL->assign('PATH', $IN[PATH]);
		//$TPL->assign('width', $length*7 + 20);
		$TPL->assign('width', $finalWidth + 22);
		$TPL->assign('fileList', $fileList);
