<?php
/**
 * http://www.91yxq.com/cycs2/quba/reg.php?qbuid=4779300&adid=1
 */
	if (empty($_GET['qbuid']) || empty($_GET['adid'])) {
		exit('所有参数均不能为空!');
	}
	$pcid = $_GET['qbuid'];
	$adid = $_GET['adid'];

    $url = "http://api.91yxq.com/api/_get_max_server_info.php?gid=21&agent_id=10017&adid=".$adid;
    $ch = curl_init();
		...
		<div class="container">
			<div class="bd">
				<div class="inner">
                    ...
                    <form action="http://www.91yxq.com/main.php?act=reg_quba2" method="post">
                        ...
                        <input type="hidden" name="agent_id" value="10017" />
						<input type="hidden" name="placeid" value="10082" />
