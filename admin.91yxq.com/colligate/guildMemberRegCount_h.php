  ...
  ?>
	...
	?>
        <td width="30" >
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr >
                    <td><font color="#FF0000">
                        <?php if ($s[$site_id][0]) { echo round($s[$site_id][1]/$s[$site_id][0]*100,2); } else { echo "0"; }?>%</font>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr  class="table_list_head">
        ...
        <td width="30">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr >
                    <td><font color="#FF0000">
                        <?php if ($l[$h][0]) { echo round($l[$h][1]/$l[$h][0]*100,2); } else { echo "0"; }?>%</font>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <td width="30" >
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
            ...
            <tr >
                <td><font color="#FF0000">
                    <?php if ($total[0]) { echo round($total[1]/$total[0]*100,2); } else { echo "0"; }?>%</font>
                </td>
            </tr>
      </table>
    </td>
...
黑色:注册<br>
<font color="#0000FF">蓝色:登录</font><br>
<font color="#FF0000">红色:登录率</font>
<script type="text/javascript" >
   var chart;
