...
/**
 * @通过API添加游戏列表
 * @param url http://api.demo.com/api/add_agent_member_by_api.php?time=1535456154&sign=245&agent_id=152452
 */
...
if ($aa = $mysqli->query($sql)->fetch_array()) {
    ...
    //新增渠道号
    $sql = "INSERT INTO " . ADMINTABLE . "." . GUILDINFO . " (`agentname`, `url`) VALUES ('" . $agentname ."', '" . $url . "')";echo $sql;
    if ($mysqli->query($sql)) {
        $sql = "SELECT id, agentname FROM " . ADMINTABLE . "." . GUILDINFO . " where url = '" . $url . "'";
