...
class psn_admin extends iData
{
				...
				public function mkDir( $dirname, $mode = 777 )
				{
								switch ( $this->psnInfo[publish_type] )
								{
								case "local" :
				...
				public function _delFile( $filename )
				{
				...
				public function _ftp_delFile( $filename )
				{
				...
				public function _upload( $filename, $destination )
				{
				...
				public function _ftp_upload( $filename, $destination )
				{
								$path = $this->psnInfo[publish_path].$destination;
								$pathInfo = pathinfo( $path );
				...
				public function logIt( $FileName, $Type )
				{
								global $table;
								$this->flushData( );
