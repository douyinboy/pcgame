...
class collection_cate_admin extends iData
{
				...
				public function updateRule( $CateID, $ContentFieldID )
				{
								global $table;
								global $iWPC;
								global $sys;
				...
				public function isRuleExists( $CateID, $ContentFieldID )
				{
								global $table;
								global $db;
								global $sys;
				...
				public function getRules( $CateID )
				{
								global $table;
								global $db;
								global $sys;
				...
				public function haveSon( $CateID )
				{
								global $table;
								global $db;
								global $sys;
