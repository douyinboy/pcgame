...
/**
 *http://api.91yxq.com/api/bengbeng/get_reward_by_api.php?idCode=7778&gid=19
 */
...
switch ($game_id) {
    case 2:
        $server_id_arr = [8, 9, 10, 11, 12, 13, 14];break;   //斗破沙城
    case 3:
        $server_id_arr = [8, 9, 10, 11, 12, 13, 14];break;   //热血虎卫
    case 19:
...
//    $content = iconv("gb2312","utf-8",$content);
    ...
    $xml .= '<ChongZhi>' . $total . '</ChongZhi>';     //用户充值累计
    $xml .= '</Result>';
}
echo $xml;
