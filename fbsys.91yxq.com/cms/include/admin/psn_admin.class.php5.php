...
class psn_admin extends iData
{
				...
				public function _ftp_upload( $filename, $destination, $URL = "" )
				{
								...
								{	
								     ...
								     * 同步 cdn
								     */
									if(preg_match('/image.(91wan|2918|915|5a).com/',$path)){// 上传目标服务器的路径包含资源服务器的 
										$file_type=strtolower(strrchr($path,"."));
										if(!in_array($file_type,array('.jpg','.jpeg','.gif','.png','bmp'))){//图片类不再推送 11-24
											$cdn_path = "http:/".$path;
