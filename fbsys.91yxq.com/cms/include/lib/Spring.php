...
class Spring
{
	...
	public $appcontext = array( );
	public $registerBeans = array( );

	public function Spring( $_ClassPathResource )
	{
	...
	public function &getInstance( $_ClassPathResource )
	{
		...
		else
		{
			...
			return $GLOBALS['GLOBALS']['__Object_SpringBeanFactory'];
				...
				public function &getBean( $_bean )
				{
								...
								else if ( isset( $GLOBALS[$_bean_instance_name] ) )
								{*/
	...
	public function &createBean( $_bean )
	{
	...
	public function destoryBean( $_bean )
	{
		$_bean_instance_name = "_SPRING_INSTANCE_".$_bean;
		if ( isset( $GLOBALS[$_bean_instance_name] ) )
		{
