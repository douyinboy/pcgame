...
class FTP
{
				...
				public $relateDir = NULL;
				public $file_list = array( );
				public $file_view_ext = array( );
				public $viewMode = NULL;
				public $viewMode_cate_type = NULL;
				public $NodeID = 0;
				public $limit = array( );
				...
				public function fileNameFilter( )
				{
				}
...
class Upload extends iData
{
				...
				public $uploadFileArray = NULL;
				public $POST_File = NULL;
				public $upload_num = NULL;
				public $saveFile = NULL;
				public $saveMiniFile = NULL;
				public $NodeID = NULL;
				public $uploadType = NULL;
				public $makeMini = NULL;
				public $miniHeight = NULL;
				public $miniWidth = NULL;
				public $changeName = NULL;
				public $rootPath = NULL;
				public $imgAllowSuffix = "gif|jpg|jpeg|png";
				public $imgAllowSize = 640000;

				public function POST_Data_handler( )
				{
								global $SYS_ENV;
				...
				public function Counter( $num = 1, $type = "img" )
				{
								global $db;
								global $table;
								switch ( $type )
				...
				public function test_filetype( $upfilename_name, $allow_upimgtype )
				{
								global $SYS_ENV;
								global $_LANG_ADMIN;
				...
				public function test_filesize( $upfilename_size, $allow_upimgsize )
				{
								global $SYS_ENV;
								global $_LANG_ADMIN;
				...
				public function get_file_ext( $filename, $mode = 0 )
				{
