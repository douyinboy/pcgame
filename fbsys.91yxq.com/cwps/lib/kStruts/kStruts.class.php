...
class kStruts
{
				...
				public function kStruts( &$STRUTS_CONFIG, &$IN )
				{
								global $db_config;
								global $db;
								global $SYS_ENV;
...
class kStruts_BeforeFilter
{
				...
				public function doFilter( &$ActionMapping, &$IN, &$TPL )
				{
				}
...
class kStruts_AfterFilter
{
				...
				public function doFilter( &$IN, &$TPL )
				{
				}
...
class ActionMapping
{
				...
				public function doForwardAction( $url_forward, $jumpMsg = "", $jumpTime = 1, $params = array( ) )
				{
