...
class tplAdmin extends iData
{
				...
				public function getAllbyType( $cId, $type )
				{
								global $table;
								global $db;
				...
				public function addTpl( $cId, $tpltype, $tplname, $tplcontent )
				{
								global $db;
								global $tplname;
				...
				public function writeTPL( &$cId, &$tplname, &$content )
				{
				...
				public function tplExist( $cId, $tplname )
				{
								global $table;
								global $db;
