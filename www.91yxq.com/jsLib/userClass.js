...
function LogoutWithGoto(aBackFlag){
    ...
    LogoutUrl = "http://www.demo.com/api/check_login_user.php?act=logout" + "&backurl=" + encodeURIComponent(gotoUrl) ; // 这里要完善为encodeUrl
...
function sendLogDataBysid(aFrmLog) {
    ...
    frmActionUrl = 'http://www.demo.com/turn.php?act=gamelogin&game_id='+game_id+'&server_id='+server_id;
